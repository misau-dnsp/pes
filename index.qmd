...
```{r plot-objectivo-plot, fig.width=8.5, fig.height=3.5, fig.align='left', fig.bg="transparent"}
...
tbl_activities_objectivo %>% 
  ...
  mutate(
    objectivo_pess = str_wrap(objectivo_pess, width = 50),  # wrap after ~25 characters
